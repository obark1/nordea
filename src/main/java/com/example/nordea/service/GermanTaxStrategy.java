...
public class GermanTaxStrategy implements TaxStrategy {
    ...
    private static final BigDecimal SURCHARGE = new BigDecimal("0.055");
    private static final BigDecimal ALLOWANCE = new BigDecimal("1000");
    ...
    public TaxResult calculate(TaxInput taxInput) {
        ...
        final BigDecimal tax = totalInvestedAmount.compareTo(ALLOWANCE) <= 0 ?
                ...
                totalInvestedAmount
                    .subtract(ALLOWANCE)
                    .multiply(TAX_RATE.multiply(BigDecimal.ONE.add(SURCHARGE)))
